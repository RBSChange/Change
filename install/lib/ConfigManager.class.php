...
class ConfigManager
{
	 ...
	 * @var string
	 */
	public $productVersion = "3.6.9";
	
	/**
	 * @var string
	 */
	public $frameworkRepo = "3.6.9";
	...
	public function initialise()
	{
		...
		$this->parameters['DB_HOST'] = 'mysql';
		$this->parameters['DB_PORT'] = '3306';
		$this->parameters['DB_USER'] = 'rbschange';
		$this->parameters['DB_PASSWORD'] = 'rbsch@nge';
		...
		$this->parameters['SOLR_URL'] = 'http://solr:8983/solr';
	...
	public function applyConfiguration()
	{
		...
		foreach ($oldlines as $line)
		{
			...
			else if (strpos($line, 'PROJECT_LICENSE=OS') === 0)
			{
				$lines[] = 'PROJECT_LICENSE=' . $this->parameters['KEY'];
			}
			else
			{
				$lines[] = $line;
