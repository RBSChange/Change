...
include PROJECT_HOME_PATH . '/install/lib/LocaleManager.class.php';
...
if (!in_array($step, array('01', '02', '03'))) {
	$step = '01';
}
...
<body>
	<div class="header">
		<h1>
		<?php echo str_replace("{productTitle}", $configManager->getProductTitle(), $localeManager->getLocales('webinstaller.index.title')); ?>
		</h1>
	</div>
	<div class="content">
